...
{{- define "cnfTplMetadata_2_10" -}}
{{- include "metaSpec_2_10" (merge (dict "specOffset" (add $.setOffset 0 | int) "metaSpec" $.metadata) (dict "nfVariables" $.cnfHdr.nfVariables)) -}}
{{- end -}}
...
{{- include "tmaasSpec_2_10" (merge (dict "specOffset" (add $specOffset 4 | int)) (dict "nfVariables" .nfVariables)) -}}
...
{{- (.nfVariables.root.Files.Glob ($.nfVariables.pathformat|toString)).AsConfig | trimSuffix "\n" | nindent (add $specOffset 2 | int) }}
{{- end -}}
...
{{- include "configMapDataSpec_2_10" (dict "specOffset" (add $specOffset 0 | int) "configMapDataSpec_2_10" ("") "nfVariables" .nfVariables) -}}
